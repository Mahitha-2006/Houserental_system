...
const BengaluruProperties = () => {
  ...
  const fetchProperties = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/properties/city/Bengaluru?${params}`);
  ...
  const fetchPropertyTypes = async () => {
    try {
      const response = await fetch(`${API_URL}/cities/Bengaluru/types`);
      if (response.ok) {
        const data = await response.json();
  ...
  if (loading) {
    return (
      <div style={styles.loadingContainer}>
        ...
        <p>Loading Bengaluru properties...</p>
      </div>
    );
  }
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <h1 style={styles.title}>Properties in Bengaluru</h1>
                ...
                <div style={styles.card} className="property-card">
                  <div style={styles.imageContainer}>
                    ...
                    <span style={styles.locationBadge}>
                      <FaMapMarkerAlt /> {property.location?.split(',')[0] || 'Bengaluru'}
                    </span>
...
export default BengaluruProperties;